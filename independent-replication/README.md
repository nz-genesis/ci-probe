...
3. Produce a raw submission containing your basis, case mappings, deletion analysis, counterexamples, uncertainty, provenance, candidate visibility, and `challenge_sha256`. Preserve any out-of-challenge obligations or challenge criticisms in the raw result as additional fields or accompanying report.
