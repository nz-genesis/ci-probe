...
The participant MUST recompute the SHA-256 from the exact challenge bytes actually received. A Git blob SHA-1 or commit SHA is not a substitute for the content SHA-256.
